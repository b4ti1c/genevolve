...
class Person {
    ...
    static generateGene() { throw new Error('GenerateGene method must be overridden'); }

    static getPrintPrecision() { throw new Error('GetPrintPrecision method must be overridden'); }

    static TestData() { throw new Error('TestData method must be overridden'); }

    genomeToString() { throw new Error('GenomeToString method must be overridden'); }
